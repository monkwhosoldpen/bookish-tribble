...
import { NativeOnlyAnimatedView } from '@/registry/components/ui/native-only-animated-view';
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      {...props}>
      <>{children}</>
      <Icon as={MaterialIcons} name="keyboard-arrow-down" aria-hidden={true} className="text-muted-foreground size-4" />
    </SelectPrimitive.Trigger>
  );
}
    ...
    <SelectPrimitive.Item
      ...
      <View className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <Icon as={MaterialIcons} name="check" className="text-muted-foreground size-4 shrink-0" />
        </SelectPrimitive.ItemIndicator>
      </View>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}>
      <Icon as={MaterialIcons} className="size-4" />
    </SelectPrimitive.ScrollUpButton>
  );
}
